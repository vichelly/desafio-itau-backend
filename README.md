# aprendendo spring se baseando no desafio-itau-backend
...
no meu caso estou usando nomes diferentes, use o exemplo abaixo caso for testar a api

```json
{
    "value": 1223.45,
    "dateTime": "2025-03-19T11:03:00.789-03:00"
}
```
